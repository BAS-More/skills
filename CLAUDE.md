...
# Mandatory Claude/agent session entry point
...
5. [`CLAUDE-PROJECT-RULES.md`](CLAUDE-PROJECT-RULES.md), when present
...
After the handover, follow all preserved project rules.
